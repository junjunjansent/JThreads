...
const editVariant = async (bodyData, productId, variantId) => {
  const url = `${productService_BASE_URL}/${productId}/${variantId}`;
...
export { createProduct, editProduct, createVariant, editVariant };
